<nav class="side-navbar">
  <div class="sidebar-header d-flex align-items-center justify-content-center p-3 mb-3">
    ...
    <div class="sidenav-header-inner text-center"><img class="img-fluid rounded-circle avatar mb-3"
        src="{{ asset('img/avatar-7.jpg') }}" alt="person">
  ...
  <!-- Sidebar Navigation Menus--><span
    class="text-uppercase text-gray-500 text-sm fw-bold letter-spacing-0 mx-lg-2 heading">Menu</span>
  <ul class="list-unstyled">
    ...
    <li class="sidebar-item"><a class="sidebar-link dropdown-toggle" href="#cuestionarios" data-toggle="collapse">
        <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
          <use xlink:href="#portfolio-grid-1"> </use>
        </svg>Cuestionarios</a>
      <ul class="collapse list-unstyled " id="cuestionarios">
        <li><a class="sidebar-link" href="/cuestionarios">Desplegar Cuestionarios</a></li>
        <!-- <li><a class="sidebar-link" href="#">Crear Plantilla</a></li> -->
      </ul>
    </li>
    @if (Auth::user()->role_id == 1)
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand ms-2" href="#">
              <div class="brand-text d-none d-md-inline-block text-uppercase letter-spacing-0">
                <span class="text-white fw-normal text-xs">Evaluación de </span><strong class="text-primary text-sm">
                  Carreras</strong>
              </div>
            </a>
          </div>
