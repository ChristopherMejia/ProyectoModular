                              ...
                              <div id="Pregunta_{{ $i }}_{{ $j }}_{{ $k }}"
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                  <label class="form-check-label col-sm"
                                    style="margin-bottom: 10px;">{{ $k }}.
                                    Pregunta </label>
                                  <div>
                                    <input type="hidden"
                                      name="id_preguntas[{{ $i - 1 }}][{{ $j - 1 }}][]"
                                      value="{{ $pregunta->id }}">
                                ...
                                <div style="display: flex; align-items: center;">
                                  ...
                                  <div style="margin-right: 20px;">
                                    ...
                                    <select
                                      ...
                                      <option @if ($pregunta->tipo == 4) selected @endif value="4">
                                        Subpreguntas
                                      </option>
                                    </select>
                                  </div>
                                    ...
                                    @foreach ($subpreguntas[$i - 1][$j - 1][$k - 1] as $subpregunta)
                                      <div
                                        ...
                                        <div style="display: flex; align-items: center;">
                                          ...
                                          <label class="form-check-label" style="margin-right: 20px;">Tipo de
                                            Subpregunta
                                          </label>
